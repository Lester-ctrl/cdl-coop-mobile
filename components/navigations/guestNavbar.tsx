    ...
    <>
      ...
      <SafeAreaView style={styles.root}>
        <View style={styles.navbar}>
          ...
          <TouchableOpacity onPress={openMenu} style={styles.hamburger} activeOpacity={0.7}>
        ...
        <Animated.View style={[styles.drawer, { transform: [{ translateX: slideAnim }] }]}>
          <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.drawerHeader}>
              ...
              <TouchableOpacity onPress={closeMenu} style={styles.closeBtn} activeOpacity={0.7}>
                ...
                return (
                  <View key={item.id}>
                    <TouchableOpacity
                      ...
                      style={[styles.menuItem, active && !hasChildren && styles.menuItemActive]}
                      activeOpacity={0.75}
                    >
                      <Ionicons
                        name={item.icon}
                      ...
                      />
                      <Text style={[styles.menuLabel, active && !hasChildren && styles.menuLabelActive]}>
                        {item.label}
                      </Text>
                      {hasChildren && (
                        <Ionicons
                        ...
                        {item.subItems!.map((sub) => {
                          ...
                          return (
                            <TouchableOpacity
                              ...
                              activeOpacity={0.75}
                            >
                              <View style={[styles.subItemLine, subActive && styles.subItemLineActive]} />
                              <Ionicons
                                name={sub.icon}
                                size={18}
...
const styles = StyleSheet.create({
  ...
  drawerLogoBox:  { width: 36, height: 36, borderRadius: 8, backgroundColor: ACTIVE_BG, alignItems: 'center', justifyContent: 'center' },
  drawerBrand:    { fontSize: 16, fontWeight: '700', color: BLUE },
  closeBtn:       { width: 30, height: 30, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#F0F1F5' },
  divider:        { height: 1, backgroundColor: BORDER, marginHorizontal: 18, marginBottom: 8 },
  ...
  subItem: {
    ...
    borderRadius: 8, marginRight: 12, marginVertical: 1,
    backgroundColor: '#F5F6FA',
  },
  subItemActive:     { backgroundColor: ACTIVE_BG },
  subItemLine:       { width: 2, height: 18, borderRadius: 1, backgroundColor: BORDER, marginRight: 10 },
