...
const NAV_ITEMS: NavItem[] = [
  {
    ...
    label: "Home",
    icon: "home-outline",
    route: "/account-officer/home",
  },
  {
    id: 2,
    label: "Products & Services",
    icon: "layers-outline",
    route: "/account-officer/products-services",
  },
  {
    id: 3,
    label: "Loan & Management",
    icon: "cash-outline",
    route: "/account-officer/loan-management",
  },
  {
    id: 4,
    label: "Payments & Collections",
    icon: "wallet-outline",
    route: "/account-officer/payments-collections",
  },
  {
    id: 5,
    label: "News, Events, & Promos",
    icon: "newspaper-outline",
    route: "/account-officer/news-events-promos",
  },
  {
    id: 6,
    label: "Report & Statement",
    icon: "document-text-outline",
    route: "/account-officer/reports-statement",
  },
];
